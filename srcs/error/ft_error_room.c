...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/02/01 08:03:48 by nle-bret          #+#    #+#             */
/*   Updated: 2016/02/01 08:03:50 by nle-bret         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_is_link(char *str, t_node *graph)
{
	...
	n_parent = NULL;
	n_child = NULL;
	if (parent && (n_parent = ft_is_saved_room(parent, graph)) == NULL)
		return (0);
	...
	if (child && (n_child = ft_is_saved_room(child, graph)) == NULL)
		return (0);
	ft_strdel(&parent);
	ft_strdel(&child);
